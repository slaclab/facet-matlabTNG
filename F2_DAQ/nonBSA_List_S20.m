...
'MOTR:LI20:MC09:S8:CH1:MOTOR'; % Vertical tip-tilt E336 mount
'MOTR:LI20:MC09:S8:CH2:MOTOR'; % Horizontal tip-tilt E336 mount
'MOTR:LI20:MC09:S8:CH3:MOTOR'; % E304 Knife edge
'MOTR:LI20:MC09:S8:CH4:MOTOR'; % Darkshadow Mask V
...
'COLL:LI20:2072:MOTR.RBV'; %Notch Collimator Y "elevator" mover stage position 
...
'SIOC:SYS1:ML00:CALCOUT078'; % test PVS - grating
'SIOC:SYS1:ML00:CALCOUT079'; % text PV - laser

% Gamma2 filter selection PVs
'SIOC:SYS1:ML00:CALCOUT070'; % horizontal position of filter wheel center 
'SIOC:SYS1:ML00:CALCOUT071'; % vertical position of filter wheel center 
'SIOC:SYS1:ML00:CALCOUT069'; % radius of filter wheel

%Gamma2 Insertion/Retraction PVs
'SIOC:SYS1:ML00:AO635'; %Gamma2 x In position
'SIOC:SYS1:ML00:AO636'; %Gamma2 y In position
'SIOC:SYS1:ML00:AO637'; %Gamma2 x Out position
...
'SIOC:SYS1:ML00:CALCOUT322';
'SIOC:SYS1:ML00:CALCOUT323';
'SIOC:SYS1:ML00:CALCOUT324';
'SIOC:SYS1:ML00:CALCOUT325';
'SIOC:SYS1:ML00:CALCOUT326';
'SIOC:SYS1:ML00:CALCOUT327';
'SIOC:SYS1:ML00:CALCOUT328';
'SIOC:SYS1:ML00:CALCOUT329';
'SIOC:SYS1:ML00:CALCOUT330';
'SIOC:SYS1:ML00:CALCOUT331';
'SIOC:SYS1:ML00:CALCOUT332';
'SIOC:SYS1:ML00:CALCOUT333';
'SIOC:SYS1:ML00:CALCOUT334';
'SIOC:SYS1:ML00:CALCOUT335';
'SIOC:SYS1:ML00:CALCOUT336';
'SIOC:SYS1:ML00:CALCOUT337';
'SIOC:SYS1:ML00:CALCOUT338';
'SIOC:SYS1:ML00:CALCOUT339';
'SIOC:SYS1:ML00:CALCOUT340';

'BLEN:LI20:3014:BZ203014B_S_SUM';% BC20 BLEN
