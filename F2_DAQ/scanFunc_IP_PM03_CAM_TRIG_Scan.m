classdef scanFunc_IP_PM03_CAM_TRIG_Scan
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "TRIG:LI20:PM03:1:TDES"
        readback_PV = "TRIG:LI20:PM03:1:TDES"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_IP_PM03_CAM_TRIG_Scan(daqhandle)
