classdef scanFunc_E320_OAPhorizontal_LaserTime
   properties
       pvlist PV
       pvs
       initial_control
   ...
   methods
       function obj = scanFunc_E320_OAPhorizontal_LaserTime(daqhandle)
           ...
           obj.pvlist=[...
               PV(context,'name',"control",'pvname',obj.control_PV,'mode',"rw",'monitor',true);% Control PV OAP horizontal
               PV(context,'name',"control_LaserTime",'pvname',obj.laser_PV_control,'mode',"rw",'monitor',true);% Control PV LaserTime
               PV(context,'name',"readback",'pvname',obj.readback_PV,'mode',"r",'monitor',true);% Readback PV OAP horizontal
