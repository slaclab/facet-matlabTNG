classdef scanFunc_Collimators_witness_width
  properties
    pvlist PV
    pvs
    initial_control
  ...
  properties(Constant)
    control_PV  = "SIOC:SYS1:ML00:CALCOUT674"
    readback_PV = "SIOC:SYS1:ML00:CALCOUT674"
  ...
  methods
    ...
    function obj = scanFunc_Collimators_witness_width(daqhandle)
