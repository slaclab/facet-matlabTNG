classdef scanFunc_WIRE_LI20_3179X
    properties
        pvlist PV
        pvs
        initial_control
    ...
    methods 
        function obj = scanFunc_WIRE_LI20_3179X(daqhandle)
        ...
        function delta = set_value(obj,value)
            ...
            wire_start = lcaGet(char("WIRE:LI20:3179:XWIREINNER"));
            lcaPut(char("WIRE:LI20:3179:USEXWIRE"),1)
            lcaPut(char("WIRE:LI20:3179:USEYWIRE"),0)
