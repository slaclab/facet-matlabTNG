classdef scanFunc_LONG_LASER_TIME_Scan
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        ...
        control_PV = "SIOC:SYS1:ML02:AO502"
        readback_PV = "SIOC:SYS1:ML02:AO502"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_LONG_LASER_TIME_Scan(daqhandle)
