classdef scanFunc_GASJET_DELAY_Scan
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "TRIG:LI20:EX01:FP1_TDES"
        readback_PV = "TRIG:LI20:EX01:FP1_TDES"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_GASJET_DELAY_Scan(daqhandle)
