classdef scanFunc_JawCollimator_Right
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "COLL:LI20:2086:MOTR.VAL"
        readback_PV = "COLL:LI20:2086:MOTR.RBV"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_JawCollimator_Right(daqhandle)
