...
function [delta] = set_Quads_BDES(obj, quadPVs, values)
        ...
        control_magnetSet({quadPVs.control_PV0,quadPVs.control_PV1,quadPVs.control_PV2,...
                           quadPVs.control_PV3,quadPVs.control_PV4,quadPVs.control_PV5,...
                           quadPVs.control_PV_QS0,quadPVs.control_PV_QS1,quadPVs.control_PV_QS2},values,'action','TRIM');
        obj.daqhandle.dispMessage(sprintf('Setting %s %s %s %s %s %s %s %s %s to %0.2f %0.2f %0.2f %0.2f %0.2f %0.2f %0.2f %0.2f %0.2f', quadPVs.control_PV_FF0,quadPVs.control_PV_FF1,quadPVs.control_PV_FF2,...
                                                                                                                                         quadPVs.control_PV_FF3,quadPVs.control_PV_FF4,quadPVs.control_PV_FF5,...
                                                                                                                                         quadPVs.control_PV_QS0,quadPVs.control_PV_QS1,quadPVs.control_PV_QS2,...
