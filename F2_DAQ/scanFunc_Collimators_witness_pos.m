classdef scanFunc_Collimators_witness_pos
  properties
    pvlist PV
    pvs
    initial_control
  ...
  properties(Constant)
    control_PV  = "SIOC:SYS1:ML00:CALCOUT673"
    readback_PV = "SIOC:SYS1:ML00:CALCOUT673"
  ...
  methods
    ...
    function obj = scanFunc_Collimators_witness_pos(daqhandle)
    ...
    function delta = set_value(obj,value)
      ...
      drive_width = lcaGet('SIOC:SYS1:ML00:CALCOUT672');
      witness_center_req = value;
