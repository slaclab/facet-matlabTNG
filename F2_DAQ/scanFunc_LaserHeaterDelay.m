classdef scanFunc_LaserHeaterDelay
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "LHDL:HT10:310:LHDL_MOTR"
        readback_PV = "LHDL:HT10:310:LHDL_MOTR.RBV"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_LaserHeaterDelay(daqhandle)
