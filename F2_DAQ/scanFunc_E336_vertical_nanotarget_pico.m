classdef scanFunc_E336_vertical_nanotarget_pico
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "MOTR:LI20:MC09:S8:CH1:MOTOR"
        readback_PV = "MOTR:LI20:MC09:S8:CH1:MOTOR.RBV"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_E336_vertical_nanotarget_pico(daqhandle)
