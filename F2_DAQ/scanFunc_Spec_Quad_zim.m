classdef scanFunc_Spec_Quad_zim
  properties
    pvlist PV
    pvs
    initial_control
  ...
  properties(Constant)
    control_PV  = "SIOC:SYS1:ML00:CALCOUT053"
    readback_PV = "SIOC:SYS1:ML00:CALCOUT053"
  ...
  methods
    ...
    function obj = scanFunc_Spec_Quad_zim(daqhandle)
    ...
    function delta = set_value(obj,value)
      ...
      if isok
        incl_dipole = lcaGet('SIOC:SYS1:ML00:CALCOUT056');
        if incl_dipole == 1
