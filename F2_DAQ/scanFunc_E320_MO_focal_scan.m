classdef scanFunc_E320_MO_focal_scan
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "MOTR:LI20:MC08:S6:CH3:MOTOR"
        readback_PV = "MOTR:LI20:MC08:S6:CH3:MOTOR.RBV"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_E320_MO_focal_scan(daqhandle)
