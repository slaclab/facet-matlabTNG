classdef scanFunc_E320_YAG_horizontal
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "MOTR:LI20:MC08:S6:CH2:MOTOR"
        readback_PV = "MOTR:LI20:MC08:S6:CH2:MOTOR.RBV"
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_E320_YAG_horizontal(daqhandle)
        ...
        function delta = set_value(obj,value)
            ...
            obj.daqhandle.dispMessage(sprintf('Setting %s to %0.3f', obj.pvs.control.name, value));
            ...
            obj.daqhandle.dispMessage(sprintf('%s readback is %0.3f', obj.pvs.readback.name, current_value));
