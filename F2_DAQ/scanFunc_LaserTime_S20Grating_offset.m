classdef scanFunc_LaserTime_S20Grating_offset
    properties
        pvlist PV
        pvs
        initial_control
    ...
    properties(Constant)
        control_PV = "SIOC:SYS1:ML00:CALCOUT074";
        readback_PV = "SIOC:SYS1:ML00:CALCOUT074";
        tolerance = 0.01;
    end
    
    methods 
        
        function obj = scanFunc_LaserTime_S20Grating_offset(daqhandle)
