classdef F2_aligner_control < handle
    ...
    methods
        function s = F2_aligner_control(GUI)
            ...
            s.aList.DMNear = cAligner('CAMR:LT20:108', ... 
                'MOTR:LI20:MC06:S2:CH2', 'MOTR:LI20:MC06:S2:CH1', 540, 500,-1,-1);
            s.aList.DMFar = cAligner('CAMR:LT20:109', ... 
            ...
            s.aList.CompNear = cAligner('CAMR:LI20:201', ...
                'MOTR:LI20:MC08:S2:CH3', 'MOTR:LI20:MC08:S2:CH4', 750, 459,-1,1);
            s.aList.CompFar = cAligner('CAMR:LI20:202', ...
                'MOTR:LI20:MC08:M0:CH2', 'MOTR:LI20:MC08:M0:CH1', 373, 548,-1,-1);
            ...
            s.aList.B0 = cAligner('CAMR:LT20:204', ... 
                'MOTR:LI20:MC06:S5:CH1', 'MOTR:LI20:MC06:S5:CH2', 755, 438, -1, -1);
            s.aList.B1 = cAligner('CAMR:LT20:204', ... 
                'MOTR:LI20:MC06:S5:CH4', 'MOTR:LI20:MC06:S5:CH3', 421, 491, -1, -1);
            s.aList.B2 = cAligner('CAMR:LT20:204', ... 
                'MOTR:LI20:MC07:M0:CH2', 'MOTR:LI20:MC07:M0:CH1', 595, 500, -1, -1);
            s.aList.B3 = cAligner('CAMR:LT20:205', ... 
                'MOTR:LI20:MC07:M0:CH4', 'MOTR:LI20:MC07:M0:CH3', 499, 482, -1, -1);
            s.aList.B4 = cAligner('CAMR:LT20:206', ... 
                'MOTR:LI20:MC07:S1:CH2', 'MOTR:LI20:MC07:S1:CH1', 302, 103, 1, -1);
            s.aList.B5 = cAligner('CAMR:LT20:207', ... 
                'MOTR:LI20:MC08:M0:CH4', 'MOTR:LI20:MC08:M0:CH3', 593, 432, -1, -1);
            s.aList.B6 = cAligner('CAMR:LT20:208', ... 
                'MOTR:LI20:MC08:S2:CH2', 'MOTR:LI20:MC08:S2:CH1', 297, 222, 1, -1);
