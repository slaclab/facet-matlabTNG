classdef F2_Feedback_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        KLYSLI1041SFB_ADESLabel         matlab.ui.control.Label
  ...
  properties (Access = public)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create KLYSLI1041SFB_ADESLabel
            app.KLYSLI1041SFB_ADESLabel = uilabel(app.DL10EnergyFeedbackPanel);
            app.KLYSLI1041SFB_ADESLabel.Position = [323 141 148 22];
            app.KLYSLI1041SFB_ADESLabel.Text = 'KLYS:LI10:41:SFB_ADES';
