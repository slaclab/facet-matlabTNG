classdef BC20E_Settings_exported < matlab.apps.AppBase
  ...
  properties (Access = public)
    ...
    BC20EnergyFeedbackSettingsLabel  matlab.ui.control.Label
    ControlVariablePhaseLimitsPanel  matlab.ui.container.Panel
    EditField                 matlab.ui.control.NumericEditField
    EditField_2               matlab.ui.control.NumericEditField
    LowLabel                  matlab.ui.control.Label
    HighLabel                 matlab.ui.control.Label
    SetpointBPM2050SaturationLimitsmmPanel  matlab.ui.container.Panel
    ...
    SetpointBPM2050DeadbandLimitsmmPanel  matlab.ui.container.Panel
    EditField_5               matlab.ui.control.NumericEditField
    EditField_6               matlab.ui.control.NumericEditField
    LowLabel_3                matlab.ui.control.Label
    HighLabel_3               matlab.ui.control.Label
    SetpointBPM2050TMITLimitsNe9Panel  matlab.ui.container.Panel
  ...
  methods (Access = private)
    ...
    function startupFcn(app, FeedbackApp)
      ...
      app.aobj.SettingsGui_whichFeedback = 5 ;
      app.aobj.Feedbacks(5).SetpointVar.axhan=app.UIAxes;
      app.aobj.Feedbacks(5).SetpointVar.StripPlot=true;
      gh.BC20E_Gain = app.GainEditField ;
      gh.BC20E_ControlLimitLo = app.EditField ;
      gh.BC20E_ControlLimitHi = app.EditField_2 ;
      gh.BC20E_SetpointLimitLo = app.EditField_3 ;
      gh.BC20E_SetpointLimitHi = app.EditField_4 ;
      gh.BC20E_SetpointFilterFreq = app.FilterFreqEditField ;
      gh.BC20E_SetpointDeadbandLo = app.EditField_5 ;
      gh.BC20E_SetpointDeadbandHi = app.EditField_6 ;
      gh.BC20E_TMITLo = app.EditField_7 ;
      gh.BC20E_TMITHi = app.EditField_8 ;
    ...
    function FeedbackSettingsUIFigureCloseRequest(app, event)
      ...
      app.aobj.Feedbacks(5).SetpointVar.StripPlot=false;
      app.aobj.Feedbacks(5).SetpointVar.axhan=[];
      app.aobj.SettingsGui=[];
      app.aobj.SettingsGui_whichFeedback = 0 ;
      app.aobj.guihan.BC20EnergyFeedbackMenu.Enable = true ;
      delete(app)
    end
  ...
  methods (Access = private)
    ...
    function createComponents(app)
      ...
      % Create BC20EnergyFeedbackSettingsLabel
      app.BC20EnergyFeedbackSettingsLabel = uilabel(app.LeftPanel);
      app.BC20EnergyFeedbackSettingsLabel.FontSize = 18;
      app.BC20EnergyFeedbackSettingsLabel.FontWeight = 'bold';
      app.BC20EnergyFeedbackSettingsLabel.FontColor = [0.7176 0.2745 1];
      app.BC20EnergyFeedbackSettingsLabel.Position = [11 450 284 23];
      app.BC20EnergyFeedbackSettingsLabel.Text = 'BC20 Energy Feedback Settings';

      % Create ControlVariablePhaseLimitsPanel
      app.ControlVariablePhaseLimitsPanel = uipanel(app.LeftPanel);
      app.ControlVariablePhaseLimitsPanel.Title = 'Control Variable Phase Limits';
      app.ControlVariablePhaseLimitsPanel.Position = [17 322 260 85];

      % Create EditField
      app.EditField = uieditfield(app.ControlVariablePhaseLimitsPanel, 'numeric');
      app.EditField.HorizontalAlignment = 'center';
      app.EditField.Position = [13 17 100 22];
      app.EditField.Value = -180;

      % Create EditField_2
      app.EditField_2 = uieditfield(app.ControlVariablePhaseLimitsPanel, 'numeric');
      app.EditField_2.HorizontalAlignment = 'center';
      app.EditField_2.Position = [138 17 100 22];

      % Create LowLabel
      app.LowLabel = uilabel(app.ControlVariablePhaseLimitsPanel);
      app.LowLabel.Position = [49 38 28 22];
      app.LowLabel.Text = 'Low';

      % Create HighLabel
      app.HighLabel = uilabel(app.ControlVariablePhaseLimitsPanel);
      app.HighLabel.Position = [174 38 31 22];
      app.HighLabel.Text = 'High';

      % Create SetpointBPM2050SaturationLimitsmmPanel
      app.SetpointBPM2050SaturationLimitsmmPanel = uipanel(app.LeftPanel);
      app.SetpointBPM2050SaturationLimitsmmPanel.Title = 'Setpoint: BPM2050 Saturation Limits [mm]';
      app.SetpointBPM2050SaturationLimitsmmPanel.Position = [17 232 260 85];

      % Create EditField_3
      app.EditField_3 = uieditfield(app.SetpointBPM2050SaturationLimitsmmPanel, 'numeric');
      app.EditField_3.HorizontalAlignment = 'center';
      app.EditField_3.Position = [13 17 100 22];
      app.EditField_3.Value = -10;

      % Create EditField_4
      app.EditField_4 = uieditfield(app.SetpointBPM2050SaturationLimitsmmPanel, 'numeric');
      app.EditField_4.HorizontalAlignment = 'center';
      app.EditField_4.Position = [138 17 100 22];
      app.EditField_4.Value = 10;

      % Create LowLabel_2
      app.LowLabel_2 = uilabel(app.SetpointBPM2050SaturationLimitsmmPanel);
      app.LowLabel_2.Position = [49 38 28 22];
      app.LowLabel_2.Text = 'Low';

      % Create HighLabel_2
      app.HighLabel_2 = uilabel(app.SetpointBPM2050SaturationLimitsmmPanel);
      ...
      % Create SetpointBPM2050DeadbandLimitsmmPanel
      app.SetpointBPM2050DeadbandLimitsmmPanel = uipanel(app.LeftPanel);
      app.SetpointBPM2050DeadbandLimitsmmPanel.Title = 'Setpoint: BPM2050 Deadband Limits [mm]';
      app.SetpointBPM2050DeadbandLimitsmmPanel.Position = [17 141 260 85];

      % Create EditField_5
      app.EditField_5 = uieditfield(app.SetpointBPM2050DeadbandLimitsmmPanel, 'numeric');
      app.EditField_5.HorizontalAlignment = 'center';
      app.EditField_5.Position = [13 17 100 22];
      app.EditField_5.Value = -0.2;

      % Create EditField_6
      app.EditField_6 = uieditfield(app.SetpointBPM2050DeadbandLimitsmmPanel, 'numeric');
      app.EditField_6.HorizontalAlignment = 'center';
      app.EditField_6.Position = [138 17 100 22];
      app.EditField_6.Value = 0.2;

      % Create LowLabel_3
      app.LowLabel_3 = uilabel(app.SetpointBPM2050DeadbandLimitsmmPanel);
      app.LowLabel_3.Position = [49 38 28 22];
      app.LowLabel_3.Text = 'Low';

      % Create HighLabel_3
      app.HighLabel_3 = uilabel(app.SetpointBPM2050DeadbandLimitsmmPanel);
      app.HighLabel_3.Position = [174 38 31 22];
      app.HighLabel_3.Text = 'High';

      % Create SetpointBPM2050TMITLimitsNe9Panel
      app.SetpointBPM2050TMITLimitsNe9Panel = uipanel(app.LeftPanel);
      app.SetpointBPM2050TMITLimitsNe9Panel.Title = 'Setpoint: BPM2050 TMIT Limits [Ne^9]';
      app.SetpointBPM2050TMITLimitsNe9Panel.Position = [17 49 260 85];

      % Create EditField_7
      app.EditField_7 = uieditfield(app.SetpointBPM2050TMITLimitsNe9Panel, 'numeric');
      app.EditField_7.HorizontalAlignment = 'center';
      app.EditField_7.Position = [13 17 100 22];
      app.EditField_7.Value = 0.5;

      % Create EditField_8
      app.EditField_8 = uieditfield(app.SetpointBPM2050TMITLimitsNe9Panel, 'numeric');
      app.EditField_8.HorizontalAlignment = 'center';
      app.EditField_8.Position = [138 17 100 22];
      app.EditField_8.Value = 50;

      % Create LowLabel_4
      app.LowLabel_4 = uilabel(app.SetpointBPM2050TMITLimitsNe9Panel);
      app.LowLabel_4.Position = [49 38 28 22];
      app.LowLabel_4.Text = 'Low';

      % Create HighLabel_4
      app.HighLabel_4 = uilabel(app.SetpointBPM2050TMITLimitsNe9Panel);
  ...
  methods (Access = public)
    ...
    % Construct app
    function app = BC20E_Settings_exported(varargin)
