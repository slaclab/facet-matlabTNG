...
methods(Access = public)
    ...
    % get single-element R matrices between elem1 and elem2
        arguments
            obj F2_ModelReceiver
            elem1;
            elem2 = elem1;
        end
        [i1, i2] = obj.getIndex(elem1, elem2);
    ...
    function [i1,i2] = getIndex(obj, elem1, elem2)
    % gets the numeric beamline index for 'elem1' and optionally for a second 'elem2'
        arguments
            obj F2_ModelReceiver
            elem1;
            elem2 = elem1;
        end
        i1 = obj.beamlineIndex(elem1);
        i2 = obj.beamlineIndex(elem2);
    end

    function idx = beamlineIndex(obj, elem)
