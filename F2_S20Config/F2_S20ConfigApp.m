...
%         obj.guihan.ListBox.Value = obj.WaistDesName ; % need to deal with waist pointer text
    ...
    function WaistCalc(obj)
      ...
      zreg = [BEAMLINE{obj.LM.ModelID(6)}.Coordf(3)  BEAMLINE{obj.LM.ModelID(7)}.Coordi(3) ...
              BEAMLINE{obj.LM.ModelID(12)}.Coordf(3) BEAMLINE{obj.LM.ModelID(13)}.Coordi(3) ...
              BEAMLINE{obj.LM.ModelID(18)}.Coordf(3) T.z(end) ];
