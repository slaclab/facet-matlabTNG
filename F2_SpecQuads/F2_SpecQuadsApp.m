classdef F2_SpecQuadsApp < handle
    events
    ...
    methods
        ...
        function obj = F2_SpecQuadsApp(apph)
        ...
        function Calc_m11(obj,app)
            
            
            E = caget(obj.pvs.Energy);
            Z_Obj = caget(obj.pvs.Z_Object);
            Z_Img = caget(obj.pvs.Z_Image);
            M11 = obj.guihan.M11EditField.Value;
            M34 = caget(obj.pvs.M34);
            incl_dipole = lcaGetSmart('SIOC:SYS1:ML00:CALCOUT056');
            ...
            [isok, BCALC0, BCALC1, BCALC2] = calc_QS_m11(Z_Obj, Z_Img, DeltaE, M11, M34);
