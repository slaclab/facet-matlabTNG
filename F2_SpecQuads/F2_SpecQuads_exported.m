classdef F2_SpecQuads_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        M11EditFieldLabel            matlab.ui.control.Label
        M11EditField                 matlab.ui.control.NumericEditField
        M11CheckBox                  matlab.ui.control.CheckBox
        M12CheckBox                  matlab.ui.control.CheckBox
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.M12CheckBox.Value = true;
        end

        % Button pushed function: CalcButton
        function CalcButtonPushed(app, event)
            if app.M12CheckBox.Value == true
                app.aobj.Calc(app);
            elseif app.M11CheckBox.Value == true
                app.aobj.Calc_m11(app);
            end
        end
        ...
        % Value changed function: M11CheckBox
        function M11CheckBoxValueChanged(app, event)
            if app.M11CheckBox.Value == true
                app.M12CheckBox.Value = false;
            else
                app.M12CheckBox.Value = true;
            end
        end

        % Value changed function: M12CheckBox
        function M12CheckBoxValueChanged(app, event)
            if app.M12CheckBox.Value == true
                app.M11CheckBox.Value = false;
            else
                app.M11CheckBox.Value = true;
            end
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 927 365];
            ...
            app.SpectrometerParametersPanel.Position = [1 2 292 364];
            ...
            app.EnergyGeVEditFieldLabel.Position = [9 309 79 22];
            ...
            app.EnergyEditField.Position = [100 309 73 22];
            ...
            app.ZObjectmEditFieldLabel.Position = [17 272 71 22];
            ...
            app.ZObjectEditField.Position = [100 272 73 22];
            ...
            app.ZImagemEditFieldLabel.Position = [18 236 70 22];
            ...
            app.ZImageEditField.Position = [100 236 73 22];
            ...
            app.M12EditFieldLabel.Position = [59 164 29 22];
            ...
            app.M12EditField.Position = [100 164 73 22];
            ...
            app.M34EditFieldLabel.Position = [59 128 29 22];
            ...
            app.M34EditField.Position = [100 128 73 22];
            ...
            app.CalcButton.Position = [67 26 143 24];
            ...
            app.DipoleSwitchLabel.Position = [122 95 49 22];
            ...
            app.DipoleSwitch.Position = [118 68 56 25];
            app.DipoleSwitch.Value = 'Without';
            ...
            app.ZobDropDown.Position = [185 270 82 22];
            ...
            app.ZimDropDown.Position = [185 236 82 22];
            app.ZimDropDown.Value = 'Select...';

            % Create M11EditFieldLabel
            app.M11EditFieldLabel = uilabel(app.SpectrometerParametersPanel);
            app.M11EditFieldLabel.HorizontalAlignment = 'right';
            app.M11EditFieldLabel.Position = [60 200 28 22];
            app.M11EditFieldLabel.Text = 'M11';

            % Create M11EditField
            app.M11EditField = uieditfield(app.SpectrometerParametersPanel, 'numeric');
            app.M11EditField.ValueDisplayFormat = '%11.4f';
            app.M11EditField.Position = [100 200 73 22];

            % Create M11CheckBox
            app.M11CheckBox = uicheckbox(app.SpectrometerParametersPanel);
            app.M11CheckBox.ValueChangedFcn = createCallbackFcn(app, @M11CheckBoxValueChanged, true);
            app.M11CheckBox.Text = '';
            app.M11CheckBox.Position = [46 199 26 22];

            % Create M12CheckBox
            app.M12CheckBox = uicheckbox(app.SpectrometerParametersPanel);
            app.M12CheckBox.ValueChangedFcn = createCallbackFcn(app, @M12CheckBoxValueChanged, true);
            app.M12CheckBox.Text = '';
            app.M12CheckBox.Position = [46 163 26 22];

            % Create MagnetValuesPanel
            app.MagnetValuesPanel = uipanel(app.UIFigure);
            app.MagnetValuesPanel.Title = 'Magnet Values';
            app.MagnetValuesPanel.Position = [293 2 377 364];
            ...
            app.Q0DLGPS3141EditFieldLabel.Position = [22 240 104 22];
            ...
            app.Q1DLGPS3261EditFieldLabel.Position = [22 206 104 22];
            ...
            app.Q2DLGPS3091EditFieldLabel.Position = [22 172 104 22];
            ...
            app.B5DBDESEditField.Position = [231 138 55 22];

            % Create BCALCLabel
            app.BCALCLabel = uilabel(app.MagnetValuesPanel);
            app.BCALCLabel.FontWeight = 'bold';
            app.BCALCLabel.Position = [160 275 47 22];
            ...
            app.Q0DBCALCEditField.Position = [155 240 55 22];
            ...
            app.Q1DBCALCEditField.Position = [155 206 55 22];
            ...
            app.Q2DBCALCEditField.Position = [155 172 55 22];

            % Create B5DBCALCEditField
            app.B5DBCALCEditField = uieditfield(app.MagnetValuesPanel, 'numeric');
            app.B5DBCALCEditField.Position = [155 138 55 22];
            ...
            app.DisplayLogTextAreaLabel.Position = [13 312 68 22];
            app.DisplayLogTextAreaLabel.Text = 'Display Log';

            % Create LogTextArea
            app.LogTextArea = uitextarea(app.LogPanel);
            app.LogTextArea.Position = [16 89 230 247];
            ...
            app.ClearLogButton.Position = [166 54 80 24];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = F2_SpecQuads_exported
